...
<p style="color: white; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;" >Developed By Praneet S</p>
<style>
...
#Jaeger{
    background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6AOxnbnZOTNtnTtZN9vHCQbKNdKrENqsNKQ&usqp=CAU);
}
#Yagami{
